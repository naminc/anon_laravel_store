            ...
            <div class="product-grid">
              ...
              <div class="showcase">
                <div class="showcase-banner">
                  <img src="{{ asset($product->images) }}" alt="{{ $product->name }}" width="300" class="product-img default">
                  <img src="{{ asset($product->images) }}" alt="{{ $product->name }}" width="300" class="product-img hover">
